...
if (isset($_GET["id"])) {
    ...
    if ($result->num_rows > 0) {
        ...
        // Get the total number of appointments for the schedule
        $sql3 = "SELECT nop FROM schedule WHERE scheduleid = $id";
        $result3 = $database->query($sql3);
        $row3 = $result3->fetch_assoc();
        $totalAppointments = $row3["nop"];

        $sql4="SELECT * FROM appointment WHERE scheduleid = $id && pid= $userid";
        $resul4=$database->query($sql4);
        // if(){
        // Calculate the appointment time based on the schedule time and appointment number
        $offsetMinutes = 10 * $apponum;
        $appointmentDateTime = new DateTime($scheduledate . ' ' . $scheduletime);
        $appointmentTime = date('Y-m-d H:i:s', strtotime($scheduledate . ' ' . $row["scheduletime"] . " + $offsetMinutes minutes"));
        // Check if the number of appointments is less than the total number of available appointments
        if ($apponum <= $totalAppointments&&$resul4->num_rows==0) {
            echo '
                    ...
                    <div  class="dashboard-items search-items"  >
                        <div style="width:100%">
                            ...
                            <div class="h3-search" style="font-size:18px;">
                                ...
                                your Session Starts : ' . $appointmentTime . '<br>
        ...
        else if($apponum > $totalAppointments) {
            echo '
        ...
        <div class="popup">
            <center>
                ...
                <div class="content">
                    Web App<br>
                    All appointments for this schedule have been booked. Please book for the next available schedule.
                </div>
            </center>
            <br><br>
        </div>
           ...
           <div class="popup">
               <center>
                   ...
                   <div class="content">
                       Web App<br>
                       "You have already booked an appointment. Please check your booking details."
                   </div>
               </center>
               <br><br>
           </div>
